...
Visualisointi Pygame-kirjaston avulla toimii hyvin, mutta realiaikainen animointi on melko hidas.  Pygame-kirjaston rutiinien nopeutta pitänee optimoida.
...
IDA* -menetelmä tuntuu olevan hitaampi ruutukartan navigoinnissa verrattuna Dijkstran ja A*-algoritmeihin.  IDA*-menetelmä ei taida olla parhaimmillaan tällaisessa painotetussa ruutukartassa vaihtoehtoisten reittien suuren määrän takia.  Toisaalta minun algoritmitoteutuksessani saattaa olla parannettavaa.  Pitää tutkia asiaa.
